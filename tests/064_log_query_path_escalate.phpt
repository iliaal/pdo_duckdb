...
// escalate. The hazard is the sticky DuckDB writer continuing after sandbox,
// not the log path relative to basedir.
...
// The post-sandbox user query must not appear. Escalate SET lines may, if
// they ran before the writer was cleared.
